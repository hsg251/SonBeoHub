...
-- Styles
local styles = {"Sae", "Nel Rin", "Chigiri", "Shidou", "Nagi", "Nel Isagi", "Gagamaru", "Don Lorenzo", "Kunigami"}
local yOffset = 40
...
toggleButton.MouseButton1Click:Connect(function()
    ...
    toggleButton.Text = isVisible and "Hide" or "Open"
    toggleButton.BackgroundColor3 = isVisible and Color3.fromRGB(150, 50, 50) or Color3.fromRGB(50, 150, 50)
end)
